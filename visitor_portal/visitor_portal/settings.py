...
EMAIL_HOST_USER = os.getenv('EMAIL_HOST_USER', 'kars4r2@gmail.com')  # Your email address
EMAIL_HOST_PASSWORD = os.getenv('EMAIL_HOST_PASSWORD', 'Cursor@1234')  # Your email app password
